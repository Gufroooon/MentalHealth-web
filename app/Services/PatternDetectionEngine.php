...
{
    /**
     * Run analytical detection of patterns between events and signals over a 14-30 day window
     */
    public function detectPatterns(User $user, int $windowDays = 30): array
    {
        ...
        // 1. Analyze Event Proximity Correlation (e.g. 1-5 days before event)
        ...
        // 2. Sleep to Next-Day Energy Lag Pattern
        $sleepEnergyPairs = [];
