 ...
 *
 * Memproses pesan user, mendeteksi intent secara deterministic, memakai check-in sebagai konteks, dan menghasilkan jawaban NARA.
 */
...
{
    /**
     * Memproses pesan user sampai menjadi jawaban NARA yang tersimpan.
     * Pesan asli dicatat, check-in terbaru dipakai sebagai konteks, lalu teks
     * dinormalisasi dan dicocokkan ke intent deterministic sebelum response
     * beserta quick replies dikembalikan ke ChatController.
     *
     * @param  User  $user  Pemilik percakapan
     * @param  string  $userText  Pesan dari browser
     * @return array Pesan user, pesan NARA, dan quick replies
     */
    public function respond(User $user, string $userText): array
    {
        $cleanText = strtolower(trim($userText));

        // Simpan pesan asli sebelum diproses.
        ...
        // Check-in terbaru memberi konteks personal pada jawaban.
    ...
    /**
     * Menormalkan typo dan singkatan bahasa Indonesia yang umum.
     * Bentuk corrected dipakai pencocokan intent, sedangkan readable dipakai
     * ketika NARA perlu menjelaskan koreksi kepada user.
     *
     * @return array{corrected:string,readable:string}
     */
    ...
    /**
     * Membentuk response dari aturan dan template lokal berdasarkan intent.
     * Check-in terbaru menjadi konteks personal; tidak ada request ke API AI
     * eksternal sehingga hasil dapat diprediksi dan diaudit dari source code.
     */
